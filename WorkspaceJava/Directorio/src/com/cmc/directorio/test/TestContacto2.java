...
public class TestContacto2 {
	...
	public static void main(String[] args) {
		...
		Telefono telf1 = new Telefono("claro", "0982342340", 10);

        Telefono telf2 = new Telefono("movi", "0987654321", 20);

        Telefono telf3 = new Telefono("claro","0994123412", 30);

        // Crear objetos Contacto utilizando los objetos Telefono
        Contacto c1 = new Contacto("Maria", "Alvarez", telf1, 60.0);
        Contacto c2 = new Contacto("Kevin", "Toaquiza", telf2, 70.0);
        Contacto c3 = new Contacto("Yadira", "Quinga", telf3, 80.0);
